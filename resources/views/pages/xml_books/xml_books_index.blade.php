...
@section('PageTitle', "Aktarılan Kitaplar")
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    <div class="ribbon-label bg-primary fs-6" style="padding: 10px 15px;"><span class="d-flex text-white fw-bolder fs-6">Aktarılan Kitap Tablosu</span></div>
                ...
                <div class="card-body">
                    ...
                    <table id="datatable" class="table table-hover table-rounded table-row-bordered table-row-gray-200 gy-1 gs-10" style="min-height: 100%; width: 100% !important;">
                        ...
                        <tr class="fw-bolder fs-7 text-uppercase gy-5">
                            <th class="text-left" style="width: 5%;">Ref.No</th>
                            <th class="text-left" style="width: 10%;">Barkod No</th>
                            <th class="text-left" style="width: 70%;">Kitap Adı</th>
    ...
    <script>
        ...
        var initDatatable = function () {
            dt = $("#datatable").DataTable({
                ...
                responsive: false,
                pageLength: 10,
                aLengthMenu: [[10, 25, 50, 100, -1], [10, 25, 50, 100, "Tümünü Göster"]],
                ...
                info: false,
                ajax: {
                    url : "{{ route('XMLBooks.Index') }}",
                },
                columns: [
                    { data: 'id' },
                    { data: 'book_barcode_no' },
                    { data: 'book_name' },
                    { data: 'book_stock' },
                    { data: null },
                ],
